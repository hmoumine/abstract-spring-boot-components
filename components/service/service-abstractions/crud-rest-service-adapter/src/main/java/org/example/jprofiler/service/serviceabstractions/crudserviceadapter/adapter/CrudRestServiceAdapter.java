...
public class CrudRestServiceAdapter<E, ID, F> implements IDefaultCrudServicePort<E, ID, F, Iterable<E>, Optional<E>> {
    ...
    private final IFunctionalMapper<F, Optional<E>> DtoToOptionalEntityFunc;

    private final IFunctionalMapper<F, Stream<E>> dtoToStreamEntityFunc;

    private final IFunctionalMapper<E, Optional<E>> entityToEntityFunc;

    @Autowired
    public CrudRestServiceAdapter(
            final IServiceCrudProcessor<E, ID, F, Iterable<E>, Optional<E>> iServiceCrudProcessor,
            final IFunctionalMapper<F, Optional<E>> dtoToOptionalEntityFunc,
            final IFunctionalMapper<F, Stream<E>> dtoToStreamEntityFunc,
            final IFunctionalMapper<E, Optional<E>> entityToEntityFunc) {
