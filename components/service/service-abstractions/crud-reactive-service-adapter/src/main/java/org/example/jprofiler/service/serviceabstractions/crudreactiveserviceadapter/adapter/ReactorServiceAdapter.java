...
public class ReactorServiceAdapter<E, ID, F> implements IDefaultCrudServicePort<E, ID, F, Flux<E>, Mono<E>> {
    ...
    private final IFunctionalMapper<F, Mono<E>> dtoToMonoEntityFunc;

    private final IFunctionalMapper<F, Stream<E>> dtoToFluxEntityFunc;

    private final IFunctionalMapper<E, Mono<E>> entityToMonoEntityFunc;
    ...
    public ReactorServiceAdapter(final ICrudReactiveServiceCrudProcessor<E, ID, F, Flux<E>, Mono<E>> iCrudReactiveServiceCrudProcessor,
                                 final IFunctionalMapper<F, Mono<E>> dtoToMonoEntityFunc,
                                 final IFunctionalMapper<F, Stream<E>> dtoToFluxEntityFunc,
                                 final IFunctionalMapper<E, Mono<E>> entityToMonoEntityFunc) {
